...
public class QuickstartChirp3IT {
  ...
  @Test
  public void testQuickstartChirp3() throws Exception {
    // Act
    QuickstartChirp3.quickstartChirp3(projectId, recognitionAudioFile, recognizerId);
